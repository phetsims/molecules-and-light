...
define( require => {
  ...
  const BreakApartStrategy = require( 'MOLECULES_AND_LIGHT/photon-absorption/model/BreakApartStrategy' );
  const ExcitationStrategy = require( 'MOLECULES_AND_LIGHT/photon-absorption/model/ExcitationStrategy' );
