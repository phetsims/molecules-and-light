...
define( function( require ) {
  ...
  testMolecule.addInitialAtomCogOffset( testMolecule.carbonAtom, new Vector2( 150, 75 ) );
  console.log( testMolecule.getInitialAtomCogOffset( testMolecule.carbonAtom ) );
  testMolecule.getInitialAtomCogOffset( testMolecule.carbonAtom );
